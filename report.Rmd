---
title: "Cracking the Obesity Code: Unraveling the Trifecta Intricacies of Meal Patterns, Caloric Food Consuption Rate, and Snacking Habits"
...
abstract: | 
  ...
  **Results:** We find that the odds of obesity compared to normal weight increase by 0.33 for an individual who has three meals a day, frequently consumes high calorie foods and has a high rate of consumption of food between meals (snacks). 
...
This work is centered in identifying determinants associated with obesity, with particular emphasis on exploring the interplay between socioeconomic indicators and lifestyle behaviors. In Latin America, obesity rates have reached alarming levels, posing serious health risks and placing a substantial burden on healthcare systems [@paper4]. Therefore this work will address the global health issue of obesity, with a specific focus on the diverse populations of Mexico, Peru, and Colombia. By examining individuals' eating habits and physical condition, this research aims to understand the factors contributing to obesity prevalence in these regions and understand the underlying mechanisms driving the escalating rates of obesity. 
...
In Table \@ref(tab:five), we present significant coefficients of the model with three way interactions. We focus on the interaction term here noting that the odds of obesity compared to normal weight increase by 0.33 for an individual who has three meals a day, frequently consumes high calorie foods and has a high rate of consumption of food between meals (snacks) holding other factors constant. 
...
standard_errors <- sqrt(model_summary$Std..Error)[1:21]
